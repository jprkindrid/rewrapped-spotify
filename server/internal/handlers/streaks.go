...
import (
	...
	"github.com/jprkindrid/rewrapped-spotify/internal/streaks"
	"github.com/jprkindrid/rewrapped-spotify/internal/utils"
	"github.com/jprkindrid/rewrapped-spotify/internal/validation"
)

func (cfg *ApiConfig) HandlerStreaks(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	streaksData := streaks.GenerateStreaksData(data, timeParams.Start, timeParams.End)

	utils.RespondWithJSON(w, http.StatusOK, streaksData)
}
